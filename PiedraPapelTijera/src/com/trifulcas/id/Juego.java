...
public class Juego {
	...
	public String jugar() {
		...
		String resultado = jugador1.getNombre() +  " elige " + jugador1.getJugada() + " y " +jugador2.getNombre() + " elige " + jugador2.getJugada();
		_imostrar.mostrar(resultado);
		int res=_iLogica.comprobar(jugador1.getJugada(), jugador2.getJugada());
		if (res == 1) { return "El ganador es " + jugador1.getNombre(); }
        if (res == 2) { return "El ganador es " + jugador2.getNombre(); }
        return "Empate"; 
	}
}
